...
public class Main {
    ...
    JLabel iconLabel = new JLabel("❓"); // Emoji como ícone para Questões
...
private static void updateQuestion(JTextArea questionArea, JPanel alternativesPanel) {
    ...
    // Painel superior com título e ícone
    JPanel headerPanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
    headerPanel.setBackground(new Color(40, 44, 52));
    
    JLabel iconLabel = new JLabel("📐"); // Emoji como ícone
    iconLabel.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 40));
...
private static JPanel createHistoriaPanel() {
    ...
    JLabel iconLabel = new JLabel("🏛️"); // Emoji como ícone para História
    iconLabel.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 40));
...
private static JPanel createCienciasPanel() {
    ...
    JLabel iconLabel = new JLabel("🧬"); // Emoji como ícone para Ciências
    iconLabel.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 40));
...
private static JPanel createChatPanel() {
    ...
    sendButton.addActionListener(e -> {
        ...
        if (!message.isEmpty()) {
            ...
            chatArea.setCaretPosition(chatArea.getDocument().getLength()); // Rolagem automática para a última mensagem
        }
    });
    ...
    // Painel lateral com amigos e grupos
